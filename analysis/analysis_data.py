...
def plot_score_box(df, filename):
...
def plot_score_scatter(df, file_name):
...
def plot_score_area(df, file_name):
...
def plot_avg_english_by_hometown(df, filename):
...
def plot_math_score_distribution(df, column_name, show_name, filename):
    bins = range(0, 11)
